...
class TestDownloadFile:
    ...
    def test_download_with_callback(self, mock_urlopen, tmp_path):
        ...
        download_file("https://example.com/test.zip",
                      dest_path, progress_callback)
...
class TestInstallChromium:
    ...
    def test_install_force_reinstall(
        ...
        result = install_chromium(
            install_dir=tmp_path, clean_existing=False, force_reinstall=True)
